...
* **Analysis of Results - Temperature Observations**
  ...
  * The temperature distribution for both months, June and December, is symmetrical.  In other words, the mean and median for each month are the same.  In June the mean/median TOBS is 75<sup>o</sup>F/75<sup>o</sup>F.  In December, the mean/median TOBS is 71<sup>o</sup>F/71<sup>o</sup>F.  This implies that the island is not prone to extreme swings in temperature during these months.
  * The mean TOBS in Dec, 71<sup>o</sup>F, is only 4<sup>o</sup>F lower than the mean TOBS in June, 75<sup>o</sup>F.  This indicates that the island maintains a fairly consistent temperature throughout the year.
  * While the minimum TOBS in December has dropped as low as 56 <sup>o</sup>F, this occurs infrequently.  The mean TOBS in December is 71<sup>o</sup>F with a standard deviation of 4<sup>o</sup>F, indicating that the temperatures in December typically range between 67<sup>o</sup>F to 75<sup>o</sup>F.
  * The maximum TOBS in June is only 2<sup>o</sup>F higher than in December.
