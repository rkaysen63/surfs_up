...
## Overview:
"Surf n' Shake" is a proposed business that will be located on the Island of Oahu.  The business will serve surfboards, surfing gear and ice cream.  A well known surfer is very interesting in investing in "Surf n' Shake", but has expressed concern that poor weather could undermine the business' success.  The purpose of this analysis is to analyze the island's weather data and to evaluate its potential impact on the "Surf n' Shake's" success or failure. 
